...
namespace CustomSmartyPants.SmartyPants
{
	/// <summary>
...
#if !PATCH
		Inline HandleReplace(SmartyPant quote)
		{
			switch (quote.Type)
			{
				...
				case SmartyPantType.RightQuote:
					return quote;
				default:
					return quote.ReplaceBy(new LiteralInline(quote.ToString())
					{
						Span = quote.Span,
						Line = quote.Line,
						Column = quote.Column,
